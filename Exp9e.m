...
dt = 0.01;
t = 0:dt:7;
r = 2*sin(10*t) + 5*sin(3*t); % Entrada constante r = 2*sin(10t) + 5*sin(3t)
...
title("Modelo de Referência ideal r = 2sin(10t) + 5sin(3t)", "Fontsize", 15)
...
xlabel("Tempo [s]", "Fontsize", 15)
ylabel("Tensão", "Fontsize", 15)
title("MRAC Direto r = 2sin(10t) + 5sin(3t)", "Fontsize", 15)
...
xlabel("Tempo [s]", "Fontsize", 15)
ylabel("Tensão", "Fontsize", 15)
title("MRAC Indireto r = 2sin(10t) + 5sin(3t)", "Fontsize", 15)
...
title("Sinal de Controle r = 2sin(10t) + 5sin(3t)", "Fontsize", 15)
...
title("Parâmetro de controle k r = 2sin(10t) + 5sin(3t)", "Fontsize", 15)
...
xlabel("Tempo [s]", "Fontsize", 15)
ylabel("Parametro", "Fontsize", 15)
title("Parâmetro de controle l r = 2sin(10t) + 5sin(3t)", "Fontsize", 15)
